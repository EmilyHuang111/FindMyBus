                        ...
                        ForEach(0..<12, id: \.self) { rowIndex in
                            HStack(spacing: 0) {
                                ...
                                TextField("Bus #", text: $textFieldValues[rowIndex][0])
                                    ...
                                    .padding(2)
                                    .background(textFieldValues[rowIndex][0] == userPreferredBusNumber ? Color.yellow : Color.clear)
                                    .border(Color.gray, width: 0.5)
                                ...
                                TextField("Bus #", text: $textFieldValues[rowIndex][1])
                                    ...
                                    .frame(width: 145, height: 18)
                                    .padding(2)
                                    .background(textFieldValues[rowIndex][1] == userPreferredBusNumber ? Color.yellow : Color.clear)
                                    .border(Color.gray, width: 0.5)
                                    .disabled(userRole != "Admin")
                            }
                        }
