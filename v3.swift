...
struct CalendarView: View {
        ...
        VStack {
            ...
            .alert(isPresented: $showSelectedDateMessage) {
                Alert(
                    ...
                    message: Text("\(formattedSelectedDate())"),
                    dismissButton: .default(Text("OK")) {
                        ...
                        if let selectedDate = dateFormatter.date(from: selectedDateString) {
                            print(selectedDate)
                            print(Date())
                            fetchBusInfo_new(for: selectedDate)
    ...
    private func okButtonTapped() {
        ...
        // Fetch bus info for the selected date
        fetchBusInfo_new(for: selectedDate)
    }
    ...
    private func fetchBusInfo_new(for date: Date) {
        let db = Firestore.firestore()
...
struct BusTableView: View {
    ...
    let departureTimes: [String: String] = [
        ...
        "Pompano Beach High School": "4:00 PM"
    ]
                    ...
                    leading:
                        HStack {
                            ...
                            Button(action: {
                                   ...
                                   .background(
                                       NavigationLink(
                                           destination: CalendarView(schoolName: schoolName),
...
struct SignUpView: View {
    ...
    private let schoolAdminPasswords: [String: String] = [
        ...
        "Pompano Beach High School": "admin123PBHS"
    ]
